import { fetchAbuseReport } from "@src/services/AbuseIPDB";
import { fetchDBIP } from "@src/services/DBIP";
import { fetchVirusTotalData } from "@src/services/Virustotal";
async function searchIP({ params }: { params: { ip: string } }) {
    try {
        ...
        return { success: true, data1: Abuseresult, data2: Virusresult, data3: DBIPresult};
