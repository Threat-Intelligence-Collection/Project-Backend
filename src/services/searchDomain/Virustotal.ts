...
import {
  VirusTotalDomain,
  VirusTotalDomainResponseType,
} from "../../../types/searchDomainResponse/VirusTotalDomainType";
...
async function fetchVirusTotalDomainData(
  domainName: string
): Promise<VirusTotalDomain | ApiResponse> {
  ...
  try {
    ...
    return {
      success: false,
      status: 503,
      message: "Error fetching VirusTotal data",
    };
  }
}
